...
DEFAULT_MODEL = "llama3.2:latest"  # Use the faster model
...
"""
        ...
        print(f"⏱️ Timeout with {model}, trying fallback...")
        return get_fallback_response(prompt)
    except requests.exceptions.RequestException as e:
        print(f"❌ Ollama API error with {model}: {e}")
        return get_fallback_response(prompt)
...
if __name__ == '__main__':
    print("🚀 Starting SUNDAY-PAAI Ollama AI Server...")
